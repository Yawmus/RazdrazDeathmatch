...
using Random = UnityEngine.Random;
    ...
    public class CarAudio : MonoBehaviour
    {
		...
		private Vehicle m_CarController; // Reference to car we are controlling


        private void StartSound()
        {
            // get the carcontroller ( this will not be null as we have require component)
			m_CarController = GetComponent<Vehicle>();
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
					...
					if(!GameObject.Find ("Tutorial"))
				   	{
						m_LowAccel.volume = lowFade*accFade  * (1.2f / Camera.main.GetComponent<CameraModifierScript>().AI);
						m_LowDecel.volume = lowFade*decFade  * (1.2f / Camera.main.GetComponent<CameraModifierScript>().AI);
						m_HighAccel.volume = highFade*accFade  * (1.2f / Camera.main.GetComponent<CameraModifierScript>().AI);
						m_HighDecel.volume = highFade*decFade  * (1.2f / Camera.main.GetComponent<CameraModifierScript>().AI);
					}
					else
					{
